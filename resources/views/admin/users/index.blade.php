                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($user->roles->count() > 0)
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                            ...
                                            @elseif($user->hasRole('inspector')) bg-green-100 text-green-800
                                            @elseif($user->hasRole('analyst')) bg-blue-100 text-blue-800
                                            @elseif($user->hasRole('broker')) bg-yellow-100 text-yellow-800
                                            @endif">
